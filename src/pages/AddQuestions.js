                    ...
                    <div class="row">
                        <div class="col-md-4 col-lg-4">
                            <div class="mt-5 row">
                                <div class="col-md-3 col-lg-3">
                                    <div class="mb-3">
                                        <label for="exampleSelect" class="option-label form-label" >option 1</label>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="mt-5 row">
                                <div class="col-md-3 col-lg-3">
                                    <div class="mb-3">
                                        <label for="exampleSelect" class="option-label form-label"
                                        >option 2</label>
                                    </div>
                                </div>
                                <div class="option-textarea col-md-9 col-lg-9">
                ...
                <div class="option-area"><div class="row">
                    <div class="col-md-4 col-lg-4">
                        <div class="mt-5 row">
                            <div class="col-md-3 col-lg-3">
                                <div class="mb-3">
                                    <label for="exampleSelect" class="option-label form-label">option 3</label>
                                </div>
                            </div>
                            <div class="option-textarea col-md-9 col-lg-9">
                                <div class="mb-3">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="mt-5 row">
                            <div class="col-md-3 col-lg-3">
                                <div class="mb-3">
                                    <label for="exampleSelect" class="option-label form-label">option 4</label>
                                </div>
                            </div>
                            <div class="option-textarea col-md-9 col-lg-9">
                                <div class="mb-3">
